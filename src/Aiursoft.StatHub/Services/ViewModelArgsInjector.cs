...
using Aiursoft.StatHub.Controllers;
    ...
    SignInManager<User> signInManager) : IScopedDependency
{
        ...
        UiStackLayoutViewModel toInject)
    {
        ...
        toInject.AppName = localizer["StatHub"];
        ...
        UiStackLayoutViewModel toInject)
    {
        ...
        {
            AppBrand = new Link { Text = localizer["StatHub"], Href = "https://gitlab.aiursoft.com/aiursoft/StatHub" },
            Links =
            [
        ...
        toInject.Sidebar = new SidebarViewModel
        {
            ...
            {
                AppName = localizer["Aiursoft StatHub"],
                LogoUrl = "/logo.svg",
                Href = "/"
            },
